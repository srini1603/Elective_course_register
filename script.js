...
function validateForm() {
	...
	sessionStorage.setItem('name',un);
	sessionStorage.setItem('id',pw);
...
window.onload=function(){
	document.getElementById("studentname").innerHTML =sessionname;


	document.getElementById("studentid").innerHTML = sessionid;
